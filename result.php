...
$result= mysqli_query("SELECT * FROM studentdetails where studid='$rid' ");
$result1= mysqli_query("SELECT * FROM course");
$result2= mysqli_query("SELECT * FROM attendance");
$result3= mysqli_query("SELECT * FROM examination where studid='$rid'");
